    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
          <div
            className={`p-2 md:p-3 rounded-xl bg-${
              color === "gold"
                ? "bca-gold"
                : color === "cyan"
                ? "bca-cyan"
        ...
        <Link
          to={to}
          className={`inline-flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg bg-${
            color === "gold"
              ? "bca-gold"
              : color === "cyan"
              ? "bca-cyan"
            ...
            color === "gold"
              ...
              ? "bca-cyan"
              : "bca-red"
          }/30 transition-all duration-200 font-medium text-xs md:text-sm`}
        >
          Manage
          <svg
  ...
  const cards = [
    {
      ...
      description:
        "Create, edit, and manage courses with posters, pricing, and coupons.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-gold"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    },
    {
      ...
      title: "Coupons",
      description:
        "Create, edit, activate/disable coupons and set usage limits.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-gold"
          fill="none"
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M7 7h10v10H7zM3 9h2m14 0h2M3 15h2m14 0h2"
          />
        </svg>
      ),
      color: "gold",
    },
    {
      ...
      description:
        "Manage course content including videos, GitHub repos, and notes for each month.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-gold"
          fill="none"
    ...
    },
    {
      ...
      description:
        "View and manage student profiles, roles, and enrollment status.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-gold"
          fill="none"
    ...
    },
    {
      ...
      title: "Testimonials",
      description:
        "Manage student testimonials with images, comments, and ratings.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-cyan"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Manage YouTube videos for the homepage slideshow with automatic rotation.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-gold"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Track and analyze unique website visitors with daily analytics and statistics.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-cyan"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Perform important database operations like granting course access for personal payments.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-red"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
    ...
    },
    {
      ...
      description:
        "Create comprehensive quiz exams with multiple questions, track student attempts, and analyze performance.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-gold"
          fill="none"
    ...
    },
    {
      ...
      description:
        "View detailed performance analytics, leaderboards, and insights for quiz exams and student progress.",
      icon: (
        <svg
          className="w-6 h-6 text-bca-cyan"
          fill="none"
